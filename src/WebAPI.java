...
public class WebAPI {
    ...
    {
        String APIkey = "720ed859f65dcf61e5ddab53b8a0ebd4";
        ...
        {
            System.out.println(movie.getID() + " " + movie.getTitle() + " " + movie.getPosterPath() + " " + movie.getVote_average() + " " + movie.getRelease_date() + " " + movie.getVote_count());
        }
    }
    ...
    public static void parseJSON(String json, ArrayList<Movie> movies)
    {
        ...
        for (int i = 0; i < movieList.length(); i++)
        {
            ...
            double movieRate = movieObj.getDouble("vote_average");
            String movieReleaseDate = movieObj.getString("release_date");
            int movieVoteCount = movieObj.getInt("vote_count");

            Movie movie = new Movie(movieTitle, movieID, fullPosterPath, movieRate, movieReleaseDate, movieVoteCount);
            movies.add(movie);
        }
    }
}
